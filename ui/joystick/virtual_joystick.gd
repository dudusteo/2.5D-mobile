...
func _move_base(new_position: Vector2) -> void:
	_base.global_position = new_position - _base.size / 2.0 * get_global_transform_with_canvas().get_scale()

func _move_tip(new_position: Vector2) -> void:
	_tip.global_position = new_position - _tip.size / 2.0 * _base.get_global_transform_with_canvas().get_scale()
